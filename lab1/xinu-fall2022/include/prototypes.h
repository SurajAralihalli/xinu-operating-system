...
/* in file lifetime.c */
extern syscall lifetime(pid32);

/* in file addtwo.S */
extern int addtwo(int x, int y);

/* in file addfour.S */
extern int addfour(int a, int b, int c, int d);

/* in file greaterfirst.c */
extern int	greaterfirst(int x, int y);

/* in file testgreaterfirst.S */
extern int testgreaterfirst(int a, int b);

/* in file greaterfirst1.c */
extern int	greaterfirst1(int x, int y);

/* in file greaterfirst2.c */
extern int	greaterfirst2(int x, int y);

/* in file mytests.c */
extern void cpuIntensiveLow();

/* in file mytests.c */
extern void cpuIntensiveHigh();

/* in file mytests.c */
extern void testAddtwo();

/* in file mytests.c */
extern void testAddfour();

/* in file mytests.c */
extern void testTestgreaterfirst();

/* in file mytests.c */
extern void testDivideByZero();

/* in file mytests.c */
extern void lab1Tests();
